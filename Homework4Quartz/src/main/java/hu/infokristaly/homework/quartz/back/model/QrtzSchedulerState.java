...
public class QrtzSchedulerState implements java.io.Serializable {
    ...
    @EmbeddedId
    @AttributeOverrides({ @AttributeOverride(name = "schedName", column = @Column(name = "SCHED_NAME", nullable = false, length = 120)), @AttributeOverride(name = "instanceName", column = @Column(name = "INSTANCE_NAME", nullable = false, length = 200)) })
