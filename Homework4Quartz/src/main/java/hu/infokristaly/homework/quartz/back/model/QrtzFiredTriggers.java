...
public class QrtzFiredTriggers implements java.io.Serializable {
    ...
    public QrtzFiredTriggers(QrtzFiredTriggersId id, String triggerName, String triggerGroup, String instanceName, long firedTime, int priority, String state) {
        this.id = id;
    ...
    public QrtzFiredTriggers(QrtzFiredTriggersId id, String triggerName, String triggerGroup, String instanceName, long firedTime, int priority, String state, String jobName, String jobGroup, String isNonconcurrent, String requestsRecovery) {
        this.id = id;
        this.triggerName = triggerName;
        this.triggerGroup = triggerGroup;
        this.instanceName = instanceName;
    ...
    @EmbeddedId
    @AttributeOverrides({ @AttributeOverride(name = "schedName", column = @Column(name = "SCHED_NAME", nullable = false, length = 120)), @AttributeOverride(name = "entryId", column = @Column(name = "ENTRY_ID", nullable = false, length = 95)) })
