...
public class QrtzJobDetails implements java.io.Serializable {
    ...
    public QrtzJobDetails(QrtzJobDetailsId id, String description, String jobClassName, String isDurable, String isNonconcurrent, String isUpdateData, String requestsRecovery, byte[] jobData, Set<QrtzTriggers> qrtzTriggerses) {
        this.id = id;
    ...
    @EmbeddedId
    @AttributeOverrides({ @AttributeOverride(name = "schedName", column = @Column(name = "SCHED_NAME", nullable = false, length = 120)), @AttributeOverride(name = "jobName", column = @Column(name = "JOB_NAME", nullable = false, length = 200)),
    ...
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "qrtzJobDetails")
