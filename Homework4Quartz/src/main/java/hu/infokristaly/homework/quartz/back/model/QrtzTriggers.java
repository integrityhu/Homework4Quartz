...
public class QrtzTriggers implements java.io.Serializable {
    ...
    public QrtzTriggers(QrtzTriggersId id, QrtzJobDetails qrtzJobDetails, String description, Long nextFireTime, Long prevFireTime, Integer priority, String triggerState, String triggerType, long startTime, Long endTime, String calendarName,
            Short misfireInstr, byte[] jobData, QrtzSimpleTriggers qrtzSimpleTriggers, QrtzCronTriggers qrtzCronTriggers, QrtzBlobTriggers qrtzBlobTriggers, QrtzSimpropTriggers qrtzSimpropTriggers) {
        this.id = id;
        this.qrtzJobDetails = qrtzJobDetails;
    ...
    @JoinColumns({ @JoinColumn(name = "SCHED_NAME", referencedColumnName = "SCHED_NAME", nullable = false, insertable = false, updatable = false),
